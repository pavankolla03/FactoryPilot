...
## Summary
- 1076 nodes · 2069 edges · 62 communities (56 shown, 6 thin omitted)
...
### Community 0 - "Orchestrator Common Services"
Cohesion: 0.05
Nodes (56): ConnectedSocket, createUserSchema, quotaSchema, scopesSchema, updateUserSchema, goalPatchSchema, goalSchema, AgentGoal (+48 more)

### Community 1 - "Autonomy Agents (goals, runs, critic, outcomes)"
Cohesion: 0.06
...
### Community 27 - "Frontend UI Components 4"
Cohesion: 0.16
...
### Community 29 - "Tsconfig.Base.Json"
Cohesion: 0.15
...
### Community 34 - "Orchestrator Src Ops"
Cohesion: 0.22
...
### Community 43 - "Scripts / Seed-Demo.Mjs"
Cohesion: 0.70
Nodes (4): api(), ensureUser(), main(), USERS

### Community 44 - "Approuter / Resources / Favicon.Svg"
Cohesion: 0.50
...
### Community 45 - "Frontend / Public / Favicon.Svg"
Cohesion: 0.67
...
- **Why does `AuthUser` connect `Alerts & Scheduled Reports` to `Orchestrator Common Services`, `Autonomy Agents (goals, runs, critic, outcomes)`, `Chat Agent Loop 3`, `Orchestrator Src Ops`, `Chat Agent Loop`, `Auth, API Keys & Session Layer`, `Orchestrator Src Chat`, `Autonomy Agents (goals, runs, critic, outcomes) 2`, `Chat Agent Loop 2`?**
  _High betweenness centrality (0.034) - this node is a cross-community bridge._
- **Why does `DbService` connect `Orchestrator Common Services` to `Chat Agent Loop 3`, `Autonomy Agents (goals, runs, critic, outcomes)`, `Auth, API Keys & Session Layer`, `Chat Agent Loop`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **What connects `name`, `version`, `private` to the rest of the system?**
  _362 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Orchestrator Common Services` be split into smaller, more focused modules?**
